package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, ICoreUpdateReceiver
   {
      ...
      public static const const_1189:String = "client_start_time";
      
      public static const const_617:String = "is_in_room";
      
      public static const const_1252:String = "client_crash_time";
      
      public static const const_1226:String = "user_agent";
      
      public static const const_1112:String = "error_context";
      
      public static const const_817:String = "last_visited_room_id";
      
      public static const const_1154:String = "capabilities";
      
      public static const const_877:uint = 24;
       
      
      private var var_204:LatencyTracker = null;
      
      private var var_300:PerformanceTracker = null;
      
      private var _roomEngine:IRoomEngine = null;
      
      private var var_144:CoreComponent;
      
      private var var_346:IHabboHelp;
      
      private var var_989:LagWarningLogger = null;
      
      private var var_671:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_300 = new PerformanceTracker();
         var_204 = new LatencyTracker();
         var_989 = new LagWarningLogger();
         var_988 = new Array(const_877);
         var _loc4_:int = 0;
         while(_loc4_ < const_877)
         {
            var_988[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            var_144 = _loc5_;
            var_144.stateStorage[const_1189] = new Date().getTime().toString();
            var_144.stateStorage[const_1226] = !true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown";
            var_144.stateStorage[const_1154] = Capabilities.serverString;
            var_144.stateStorage[const_617] = false;
            var_144.stateStorage[const_817] = 0;
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_626:
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_300 != null)
            {
               var_300.connection = param1;
            }
            if(var_204 != null)
            {
               var_204.communication = _communication;
      ...
      {
         var_84 = IHabboCatalog(param2) as IHabboCatalog;
         var_84.events.addEventListener(CatalogPageOpenedEvent.CATALOG_PAGE_OPENED,onCatalogPageOpened);
         var_84.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
         var_84.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_275:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_160)
         {
            Component(var_160).events.addEventListener(HabboConfigurationEvent.const_18,onConfigurationLoaded);
            if(var_204 != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            var_144.stateStorage[const_817] = _loc2_.guestRoomId;
            var_144.stateStorage[const_617] = true;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_671)
            {
               var_671.release(new IIDHabboWindowManager());
               var_671 = null;
            }
            if(_navigator)
            {
            ...
            if(var_84)
            {
               if(true)
               {
                  var_84.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
                  var_84.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
               }
               var_84.release(new IIDHabboCatalog());
               var_84 = null;
            }
            if(var_32)
            {
               if(true)
               {
                  Component(var_32).events.removeEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_CLOSED,onInvetoryTrackingEvent);
                  Component(var_32).events.removeEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_FURNI,onInvetoryTrackingEvent);
                  Component(var_32).events.removeEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_POSTERS,onInvetoryTrackingEvent);
                  Component(var_32).events.removeEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_BADGES,onInvetoryTrackingEvent);
                  Component(var_32).events.removeEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_ACHIEVEMENTS,onInvetoryTrackingEvent);
                  Component(var_32).events.removeEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_TRADING,onInvetoryTrackingEvent);
               }
            ...
            if(var_159)
            {
               if(true)
               {
                  ...
                  Component(var_159).events.removeEventListener(HabboFriendListTrackingEvent.const_275,onFriendlistTrackingEvent);
               }
            ...
            if(var_346)
            {
               if(true)
               {
                  var_346.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_346.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_346.release(new IIDHabboHelp());
               var_346 = null;
            }
            if(_roomEngine)
            {
               Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_357,onLagWarningEvent);
            }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_626,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_500,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_56,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_358,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_357:
               var_989.registerWarning(LagWarningLogger.const_816);
         }
      }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_160)
         {
            Component(var_160).events.removeEventListener(HabboConfigurationEvent.const_18,onConfigurationLoaded);
         }
      }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.removeEventListener(LocalizationEvent.const_10,onLocalizationLoaded);
         }
      }
      
      private function onHelpReady(param1:IID, param2:IUnknown) : void
      {
         var_346 = param2 as IHabboHelp;
         var_346.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_346.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      
      private function onWarning(param1:ErrorEvent) : void
      {
         logError(var_144.getLastDebugMessage());
      }
      ...
      private function onCoreRunning(param1:Event) : void
      {
         ...
         if(var_144 != null)
         {
            var_144.events.removeEventListener(HabboLoginTrackingStep.const_15,onCoreRunning);
         }
      }
      ...
      {
         var_671 = IHabboWindowManager(param2);
         if(var_671)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_357,onLagWarningEvent);
      }
      ...
      private function onInventoryReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_32).events.addEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_CLOSED,onInvetoryTrackingEvent);
         Component(var_32).events.addEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_FURNI,onInvetoryTrackingEvent);
         Component(var_32).events.addEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_POSTERS,onInvetoryTrackingEvent);
         Component(var_32).events.addEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_BADGES,onInvetoryTrackingEvent);
         Component(var_32).events.addEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_ACHIEVEMENTS,onInvetoryTrackingEvent);
         Component(var_32).events.addEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_TRADING,onInvetoryTrackingEvent);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_159).events.addEventListener(HabboFriendListTrackingEvent.const_275,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         var _loc7_:* = null;
         var _loc8_:int = 0;
         if(param1.critical && !var_1461)
         {
            var_1461 = true;
            var_144.stateStorage[const_1252] = new Date().getTime().toString();
            if(var_160)
            {
               if(var_160.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc5_ = var_144.stateStorage.length;
                  _loc6_ = 0;
                  while(_loc6_ < _loc5_)
                  {
                     _loc4_[var_144.stateStorage.getKey(_loc6_)] = var_144.stateStorage.getWithIndex(_loc6_);
                     _loc6_++;
                  }
                  _loc7_ = "";
                  for each(_loc8_ in var_988)
                  {
                     _loc7_ += String(_loc8_);
                  }
                  _loc4_[const_1112] = _loc7_;
                  _loc3_.data = _loc4_;
         ...
         logError(var_144.getLastErrorMessage());
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.addEventListener(LocalizationEvent.const_10,onLocalizationLoaded);
         }
      }
      
      private function onHotelViewEvent(param1:Event) : void
      {
         if(param1.type == HabboHotelViewEvent.const_500)
         {
            trackLoginStep(HabboLoginTrackingStep.const_16);
         }
         else if(param1.type == HabboHotelViewEvent.const_358)
         {
