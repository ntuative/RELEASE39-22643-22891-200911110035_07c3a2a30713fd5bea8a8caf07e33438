package com.sulake.habbo.session.handler
{
   ...
   public class RoomDimmerPresetsHandler extends BaseHandler
   {
      ...
      private function onRoomDimmerPresets(param1:IMessageEvent) : void
      {
         ...
         var _loc6_:IRoomSession = listener.getSession(_xxxRoomId,var_51);
         if(_loc6_ == null)
         {
            return;
         }
         var _loc7_:RoomSessionDimmerPresetsEvent = new RoomSessionDimmerPresetsEvent(RoomSessionDimmerPresetsEvent.const_340,_loc6_);
