package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_303:GuestRoomDoorbell;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1831:ISessionDataManager;
      
      private var var_1829:RoomCreateViewCtrl;
      
      private var var_1832:RoomThumbnailRenderer;
      
      private var var_198:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1118:RoomInfoViewCtrl;
      
      private var var_84:IHabboCatalog;
      
      private var var_388:Tabs;
      
      private var var_428:MainViewCtrl;
      
      private var var_1830:Array;
      
      private var var_930:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_428 = new MainViewCtrl(this);
         var_1118 = new RoomInfoViewCtrl(this);
         var_1829 = new RoomCreateViewCtrl(this);
         var_1832 = new RoomThumbnailRenderer(this);
         var_930 = new GuestRoomPasswordInput(this);
         var_303 = new GuestRoomDoorbell(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_428.startSearch(Tabs.const_185,Tabs.const_295,param1);
         var_428.mainWindow.activate();
      }
      ...
      public function goToRoom(param1:int, param2:Boolean, param3:String = "") : void
      {
         ...
         if(var_36)
         {
            ...
            var_1118.close();
            var_36.gotoRoom(false,param1,param3);
         }
      }
      ...
      public function goToPublicSpace(param1:int, param2:String) : void
      {
         ...
         {
            var_1118.close();
            var_36.gotoRoom(true,param1,"",param2);
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_198.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_74,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_198 != null)
         {
            var_198.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_101,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_198.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_101,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(_windowManager.createWindow(param1,"",HabboWindowType.const_200,HabboWindowStyle.const_38,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1831 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_428.startSearch(Tabs.const_214,Tabs.const_190);
         var_388.getTab(Tabs.const_214).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_428.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
