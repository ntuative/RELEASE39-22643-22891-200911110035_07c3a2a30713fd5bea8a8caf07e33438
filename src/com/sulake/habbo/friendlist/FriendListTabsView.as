package com.sulake.habbo.friendlist
{
   ...
   public class FriendListTabsView
   {
      ...
      private function refreshHeader(param1:FriendListTab, param2:IWindowContainer) : int
      {
         ...
         var _loc4_:Boolean = param1.id == FriendListTab.const_79 && !param1.newMessageArrived;
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _friendList.trackFriendListEvent(HabboFriendListTrackingEvent.const_275);
         }
      }
      ...
      public function refresh(param1:String) : void
      {
         ...
         var_30.width = _friendList.tabs.tabContentWidth;
         var_30.findChildByName("bg").width = _friendList.tabs.tabContentWidth;
         var _loc2_:int = 1;
         for each(_loc3_ in _friendList.tabs.getTabs())
         {
            _loc4_ = var_30.getChildByName("flt_" + _loc3_.id) as IWindowContainer;
         ...
         var_30.height = _loc2_ + 1;
         var_30.findChildByName("bg").height = var_30.height;
