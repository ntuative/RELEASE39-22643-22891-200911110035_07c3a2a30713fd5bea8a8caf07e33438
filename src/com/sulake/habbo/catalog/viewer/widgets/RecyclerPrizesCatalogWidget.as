package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1607:XML;
      
      private var var_514:IGridItem;
      
      private var var_1221:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_694:PrizeViewer;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_584.length)
         {
            createLevelItem(var_584[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_694 = new PrizeViewer();
         var_877 = new Map();
         var_584 = recycler.getPrizeTable();
         if(var_584 == null)
         {
            return;
         }
         ...
         var_1607 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_584[0].prizes.length > 0)
         {
            select(var_584[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1607) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1221) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_694.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
