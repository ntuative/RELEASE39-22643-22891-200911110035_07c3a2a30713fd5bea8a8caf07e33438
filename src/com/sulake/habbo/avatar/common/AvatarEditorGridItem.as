package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridItem
   {
      ...
      private const const_1487:int = 16777215;
      
      private var _isSelected:Boolean = false;
      
      private var var_1295:BitmapData;
      
      private const const_1486:int = 13421772;
      ...
      private var var_505:IFigurePartSet;
      ...
      public function AvatarEditorGridItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:IPartColor = null, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            var_335 = new BitmapData(1,1,true,16777215);
         }
         else
         {
            var_909 = param3.isColorable;
         }
         var_909 = param5;
         var _loc8_:IAvatarRenderManager = _model.method_1.avatarRenderManager;
         updateThumbData();
      }
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            if(var_335 != null)
            {
               _loc2_ = var_335.clone();
               if(_color != null && var_909)
               {
         ...
         if(var_505 != null && false)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               _loc6_.bitmap.copyPixels(var_1295,var_1295.rect,new Point(0,0),null,null,true);
            }
         }
         if(isSelected)
         {
            _window.color = const_1486;
         }
         else
         {
            _window.color = const_1487;
         }
         _window.invalidate();
      }
      ...
      private function renderThumb() : BitmapData
      {
         ...
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_919 + "_" + FigureData.const_227;
            _loc4_ = _model.method_1.avatarRenderManager.getAssetByName(_loc3_) as BitmapDataAsset;
            if(_loc4_ != null)
            {
               _loc5_ = (_loc4_.content as BitmapData).clone();
               _loc6_ = -1 * _loc4_.offset.x - 0;
               _loc7_ = -1 * _loc4_.offset.y - 0;
               if(_color != null && var_909 && _loc2_.isColorable)
               {
      ...
      private function analyzeLayers() : void
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_919 + "_" + FigureData.const_227;
            _loc3_ = _model.method_1.avatarRenderManager.getAssetByName(_loc2_) as BitmapDataAsset;
            if(_loc3_ != null)
            {
