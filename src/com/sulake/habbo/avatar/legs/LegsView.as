package com.sulake.habbo.avatar.legs
{
   ...
   public class LegsView implements IAvatarEditorCategoryView
   {
      ...
      public function LegsView(param1:LegsModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_616["null"] = new AvatarEditorGridView(param1,FigureData.const_139,param2,param3);
         var_616["null"] = new AvatarEditorGridView(param1,FigureData.const_147,param2,param3);
         var_616["null"] = new AvatarEditorGridView(param1,FigureData.const_134,param2,param3);
         attachImages();
